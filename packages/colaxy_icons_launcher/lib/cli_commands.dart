...
Map<String, dynamic> _getConfig({String? configFile}) {
  ...
  if (configFile != null) {
    ...
    filePath = 'colaxy_icons_launcher-${_flavorHelper.flavor}.yaml';
  } else if (File('colaxy_icons_launcher.yaml').existsSync()) {
    filePath = 'colaxy_icons_launcher.yaml';
  } else {
  ...
  if (yamlMap['colaxy_icons_launcher'] is! Map) {
    CliLogger.error(
      "Your $filePath file does not contain a 'colaxy_icons_launcher' section.",
    );
    exit(1);
  }

  // yamlMap has the type YamlMap, which has several unwanted side effects
  return _yamlToMap(yamlMap['colaxy_icons_launcher'] as YamlMap);
}
